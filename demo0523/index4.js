...
let codeOver = 0;           //程式執行狀態。 0:尚未執行、1:正在執行、2:執行完畢
...
function get_object(num) {              //取得物品(物品代號)
    sound_get.play();
    diamondNum += 1;
    stageObject[player[0].nowx][player[0].nowy] = 0;
