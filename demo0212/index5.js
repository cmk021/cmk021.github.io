...
//  ];
  ...
  player[1].role.anims.play('left1', true);
...
function eat0(num) {                        //吃(要吃掉的數字)

    if ((stageNum[player[0].nowy][player[0].nowx+1] == num) && (stageFood[player[0].nowy][player[0].nowx+1] == 35)){
        move_right(0);
        //setTimeout( foodlayer.fill(0, nowx+1, nowy, 1, 1) , 1000 );
        //foodlayer.fill(0, nowx+1, nowy, 1, 1);
        //console.log("1000");
        stageFood[player[0].nowy][player[0].nowx+1] = 0;
        eatNum++;
    }
    else if ((stageNum[player[0].nowy-1][player[0].nowx] == num) && (stageFood[player[0].nowy-1][player[0].nowx] == 35)){
        move_up(0);
        //foodlayer.fill(0, nowx, nowy-1, 1, 1);
        stageFood[player[0].nowy-1][player[0].nowx] = 0;
        eatNum++;
    }
    else if ((stageNum[player[0].nowy][player[0].nowx-1] == num) && (stageFood[player[0].nowy][player[0].nowx-1] == 35)){
        move_left(0);
        //foodlayer.fill(0, nowx-1, nowy, 1, 1);
        stageFood[player[0].nowy][player[0].nowx-1] = 0;
        eatNum++;
...
function eat1(num) {                        //吃(要吃掉的數字)

    if ((stageNum[player[1].nowy][player[1].nowx+1] == num) && (stageFood[player[1].nowy][player[1].nowx+1] == 35)){
        move_right(1);
        //setTimeout( foodlayer.fill(0, nowx+1, nowy, 1, 1) , 1000 );
        //foodlayer.fill(0, nowx+1, nowy, 1, 1);
        //console.log("1000");
        stageFood[player[1].nowy][player[1].nowx+1] = 0;
        eatNum++;
    }
    else if ((stageNum[player[1].nowy-1][player[1].nowx] == num) && (stageFood[player[1].nowy-1][player[1].nowx] == 35)){
        move_up(1);
        //foodlayer.fill(0, nowx, nowy-1, 1, 1);
        stageFood[player[1].nowy-1][player[1].nowx] = 0;
        eatNum++;
    }
    else if ((stageNum[player[1].nowy][player[1].nowx-1] == num) && (stageFood[player[1].nowy][player[1].nowx-1] == 35)){
        move_left(1);
        //foodlayer.fill(0, nowx-1, nowy, 1, 1);
        stageFood[player[1].nowy][player[1].nowx-1] = 0;
        eatNum++;
